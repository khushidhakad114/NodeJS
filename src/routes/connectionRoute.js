...
const { connectionRequest, updateRequest, userConnectionRequest, getAllReceivingRequest, getAllSenderRequest, getFriendProfile, blockUser, getAllFriends } = require("../controller/connectionController");
...
connectionRouter.get("/request/getAllUserFriends",userMiddleware,getAllFriends); //get all friends
